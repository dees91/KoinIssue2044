...
class ThirdFragment : Fragment(), AndroidScopeComponent {
...
fun AnotherContent(
    ...
    viewModel: ThirdViewModel = koinViewModel()
) {
    ...
    Column(
        ...
        Text(
            text = "Fragment 3 (From Second Activity)",
            fontSize = 18.sp,
        ...
        Button(
            onClick = { viewModel.updateGreeting("Third Fragment User") },
            modifier = Modifier.padding(16.dp)
        ) {
            Text("Call UseCase from Second Activity")
        }
    }
}
